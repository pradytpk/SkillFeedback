  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <AddGoalButton employeeId={params.id} />
      </div>
      ...
      {active.length > 0 && (
        <div>
          ...
          <div className="space-y-3">
            {active.map((g) => <GoalCard key={g.id} goal={g} employeeId={params.id} />)}
          </div>
        </div>
      )}
      ...
      {paused.length > 0 && (
        <div>
          ...
          <div className="space-y-3">
            {paused.map((g) => <GoalCard key={g.id} goal={g} employeeId={params.id} />)}
          </div>
        </div>
      )}
      ...
      {completed.length > 0 && (
        <div>
          ...
          <div className="space-y-3">
            {completed.map((g) => <GoalCard key={g.id} goal={g} employeeId={params.id} />)}
          </div>
        </div>
      )}
      ...
      {cancelled.length > 0 && (
        <div>
          ...
          <div className="space-y-3">
            {cancelled.map((g) => <GoalCard key={g.id} goal={g} employeeId={params.id} />)}
          </div>
        </div>
      )}
    </div>
